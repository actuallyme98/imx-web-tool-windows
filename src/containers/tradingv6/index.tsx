...
const TradingV6Page: React.FC = () => {
  ...
  const tradingv6 = async (fileAndClient: TradingServiceV3, imxPrice: number) => {
  ...
  const onStartTrade = async () => {
    ...
    try {
      ...
      for (const fileAndClient of selectedFileAndClients) {
        promises.push(tradingv6(fileAndClient, imxPrice));
      }
