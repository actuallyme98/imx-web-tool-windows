...
export const typeReduxMiddleware: Middleware =
  (store: any) =>
  (next: (arg0: { type: unknown; payload: any; meta?: unknown; error?: boolean }) => void) =>
  (action: {
    type: any;
    payload: any;
    meta: { args: any; creator: any; resolve: any; reject: any };
  }) => {
